...
ZLIB_INTERNAL uLong crc32_crypto OF((uLong crc, const Bytef *buf, uInt len));
...
ZLIB_INTERNAL uLong crc32_copy_crypto OF((uLong crc, const Bytef *buf, uInt len, Bytef *dest));
